...
| **Live data scraped** | [data/](../data/) · [data/secrets/](../data/secrets/) |
...
**Live proof:** `data/secrets/live-remote-config.json`
...
Full list: [data/app/api-paths.txt](../data/app/api-paths.txt)
...
| Artifact | Path |
|----------|------|
| Decoded manifest | `data/app/android-manifest.xml` |
| APK strings / keys | `data/app/strings.xml` |
| All URLs | `data/app/all-urls.txt` |
| API paths | `data/app/api-paths.txt` |
| Live content scrape | `data/` |
| Production secrets | `data/secrets/` |
